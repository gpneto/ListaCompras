  ...
  if (ctx.state.nameTextController.text == '' ||
    ...
    try {
      ...
      if (user != null) {
        ...
        user.updateDisplayName(ctx.state.nameTextController.text).then((d) async{
         await UserInfoOperate.whenLogin(FirebaseAuth.instance.currentUser, ctx.state.nameTextController.text);
          Navigator.pop(
            ctx.context,
            PopWithResults(
