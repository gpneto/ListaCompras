      ...
      : super(
          ...
          shouldUpdate: (oldState, newState) {
            return oldState.locale != newState.locale ||
                oldState.selectedIndexPage != newState.selectedIndexPage ||
                oldState.pages != newState.pages ||
                oldState.defaultTargetPlatformNative != newState.defaultTargetPlatformNative
